...
export class PaymentService {
  ...
  private readonly authorizeByKey = new Map<
    string,
    { paymentId: string; status: string; errorMessage?: string }
  >();
  private readonly captureByKey = new Map<
    string,
    { success: boolean; status: string; error_message?: string }
  >();
  private readonly refundByKey = new Map<
    string,
    { success: boolean; status: string; error_message?: string }
  >();
